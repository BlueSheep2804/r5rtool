...
export default new Vuex.Store({
  ...
  actions: {
    ...
    importText(context, kvfile: string) {
      ...
      // context.commit('weaponPropertyImport', ['mag_l1', weapon.get('Mods')])
      // context.commit('weaponPropertyImport', ['mag_l2', weapon.get('Mods')])
      // context.commit('weaponPropertyImport', ['mag_l3', weapon.get('Mods')])
